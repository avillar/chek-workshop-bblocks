...
```jsonld
{
  "@context": [
    ...
    "https://raw.githubusercontent.com/avillar/chek-workshop-bblocks/undefined/build/annotated/bbr/template/myFeature/context.jsonld",
    {
      "mynamespace": "http://example.org/ns1/"
    }
  ],
...
$defs:
  MyFeature:
    ...
    - properties:
        properties:
          $ref: https://raw.githubusercontent.com/avillar/chek-workshop-bblocks/undefined/build/annotated/bbr/template/mySchema/schema.yaml
anyOf:
- $ref: '#/$defs/MyFeature'
...
* YAML version: [schema.yaml](https://raw.githubusercontent.com/avillar/chek-workshop-bblocks/undefined/build/annotated/bbr/template/myFeature/schema.json)
* JSON version: [schema.json](https://raw.githubusercontent.com/avillar/chek-workshop-bblocks/undefined/build/annotated/bbr/template/myFeature/schema.yaml)
...
[context.jsonld](https://raw.githubusercontent.com/avillar/chek-workshop-bblocks/undefined/build/annotated/bbr/template/myFeature/context.jsonld)
...
* URL: [https://github.com/avillar/chek-workshop-bblocks](https://github.com/avillar/chek-workshop-bblocks)
